          ...
          <div className="relative z-10 container mx-auto">
            <div className="mx-auto flex max-w-5xl flex-col gap-8">
              <div className="relative flex flex-col items-center gap-4 text-center sm:gap-6">
                ...
                >
                  Instantly book highly qualified plumbers, electricians,
                  cleaners, and painters. We connect you with verified
                  professionals for hassle-free, reliable service right at your
                  doorstep.
                </motion.p>
              </div>
              <motion.div
